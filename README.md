...
└── opportunities/
    └── index.html          ← "Where Are the Opportunities?"
```
...
### 4. Where Are the Opportunities? · May 2026 · 12 min
The third and final essay on Seoul's rental market. With the structural case made and the macro holding, but the conventional residential playbook blocked by the policy regime, this essay maps four pathways that deploy capital anyway — value-up acquisitions (inside the Housing Act), flexible living (office-to-rental conversion), lodging conversion (reclassification), and the new rental-dormitory framework (fully outside the Act) — each ordered by its distance from regulation, located through proprietary multi-layer GIS analytics and executed through local operators. Closes the series with three reasons to position now.
